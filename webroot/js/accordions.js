...
(function($) {
  ...
  $.accordions = function(el, options) {
    ...
    var registerEvents = function() {
      ...
      $(plugin.settings.selectorHeader,$element).off('click.accordions').on('click.accordions', function(e) {
  ...
  $.fn.accordions = function(options) {
    ...
    return this.each(function() {
      if (undefined === $(this).data('accordions')) {
        var plugin = new $.accordions(this, options);
        $(this).data('accordions', plugin);
      }
    });
