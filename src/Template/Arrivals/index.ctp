    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('lavage_id', 'MAL') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    ...
                    <?= $this->Html->link($this->Html->image('edit.png', ['alt' => 'Editer', 'class' => 'icon']), ['action' => 'edit', $arrival->id], ['escape' => false, 'title' => 'Modifier']) ?>
